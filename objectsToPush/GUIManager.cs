...
public class GUIManager : MonoBehaviour {
	...
	public GUIText baconText, balloonText, gameOverText, instructionsText;
	...
	public static void SetBalloon(int balloon){
		instance.balloonText.text = balloon.ToString() + " / 5";
	}
